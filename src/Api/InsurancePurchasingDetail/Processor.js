...
import {
    ...
    GET_INSURANCE_PURCHASING_DETAIL_INFO,
    GET_MEDICAL_RECORD,
...
async function sendGetInsurancePurchasingDetailInfoRequestAsync(insurancePurchasingInfoId)
{
    try
    {
        const {code, data} = await Function.getAsync(GET_INSURANCE_PURCHASING_DETAIL_INFO, false, {
