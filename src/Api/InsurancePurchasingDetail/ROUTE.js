...
export const SUBMIT_INSURANCE_COMPANY_VERIFY_RESULT = insurancePurchasingDetailPrefix('/submitInsuranceCompanyVerifyResult');

export const SUBMIT_PAY_CONFIRMATION = insurancePurchasingDetailPrefix('/submitPayConfirmation');